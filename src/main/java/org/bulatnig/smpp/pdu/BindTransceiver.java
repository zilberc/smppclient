 ...
 */
public class BindTransceiver extends PDU implements Responsable {
     ...
     */
    public BindTransceiver(final byte[] bytes) throws PDUException {
        super(bytes);
    }
     ...
     */
    @Override
    protected final void parseBody(final byte[] shorts)
            throws PDUException {
        if (getCommandId() != CommandId.BIND_TRANSCEIVER) {
            throw new ClassCastException();
        }
        SMPPByteBuffer bb = new SMPPByteBuffer(shorts);
        try {
     ...
     * {@inheritDoc}
     */
    public final BindTransceiverResp getResponse() {
