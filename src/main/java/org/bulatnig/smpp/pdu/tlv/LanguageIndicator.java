 ...
 */
public class LanguageIndicator extends TLV {
    /**
     ...
     */
    public LanguageIndicator(final short responseCode) {
        super(ParameterTag.LANGUAGE_INDICATOR);
        value = responseCode;
    }
     ...
     */
    public LanguageIndicator(final byte[] bytes) throws TLVException {
        super(bytes);
    }
