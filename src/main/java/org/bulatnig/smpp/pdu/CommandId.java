...
public enum CommandId {
	 ...
	 * SMSC.
	 */
	BIND_RECEIVER(0x00000001L),
	/**
	 * BindReceiver Response PDU.
	 */
	BIND_RECEIVER_RESP(0x80000001L),
	/**
	 ...
	 */
	BIND_TRANSMITTER(0x00000002L),
	/**
	 * BindTransmitter Response PDU.
	 */
	BIND_TRANSMITTER_RESP(0x80000002L),
	/**
	 ...
	 * to NULL.
	 */
	QUERY_SM(0x00000003L),
	/**
	 * QuerySM Response PDU.
	 */
	QUERY_SM_RESP(0x80000003L),
	/**
	 ...
	 */
	SUBMIT_SM(0x00000004L),
	/**
	 * SubmitSM Response PDU.
	 */
	SUBMIT_SM_RESP(0x80000004L),
	/**
	 ...
	 */
	REPLACE_SM(0x00000007L),
	/**
	 * ReplaceSM Response PDU.
	 */
	REPLACE_SM_RESP(0x80000007L),
	/**
	 ...
	 * NULL.
	 */
	CANCEL_SM(0x00000008L),
	/**
	 * CancelSM Response PDU.
	 */
	CANCEL_SM_RESP(0x80000008L),
	/**
	 ...
	 */
	SUBMIT_MULTI(0x00000021L),
	/**
	 * SubmitMulti Response PDU.
	 */
	SUBMIT_MULTI_RESP(0x80000021L),
	/**
	 ...
	 */
	ALERT_NOTIFICATION(0x00000102L),
	/**
	 ...
	 *            численное выражение ID команды
	 */
	private CommandId(final long longVal) {
		value = longVal;
	}
